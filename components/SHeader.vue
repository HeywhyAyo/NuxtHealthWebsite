      ...
      <div class="px-12 mx-auto max-w-7xl">
        ...
        >
          ...
          >
            ...
            >
              <svg
                class="w-10 h-10 text-black fill-current"
                viewBox="0 0 39 15"
          ...
          <div
            ...
            "
            x-bind:class="{
              'flex z-30 top-0 bg-white h-full fixed': showMenu,
              'hidden md:flex absolute': !showMenu,
            }"
          >
            <a
              href="#_"
          ...
          <div
            class="
              ...
              leading-10
              md:inline-block
              lg:flex-grow-0 lg:flex-shrink-0 lg:mt-0 lg:text-right
            "
          >
            <a
              href="#_"
        ...
        <div
          class="
            ...
            w-full
            mt-24
            lg:space-x-10 lg:flex-row
          "
        >
          <div class="relative z-10 w-full space-y-10 lg:w-1/2">
            <h1 class="text-5xl font-bold sm:text-7xl xl:text-8xl">
              Human Health Matters
            </h1>
            <p class="text-base text-gray-500 sm:text-lg">
              Welcome to the next generation of design. Our templates and
              components have been optimized for maximum conversion, which
              returns happier customers, more sales, and a stronger business.
            </p>
            <div
              class="flex flex-col items-center w-full space-x-5 lg:flex-row"
            >
              <a
                href="#_"
                class="
          ...
          <div class="relative z-0 w-full mt-8 lg:w-1/2">
            <img
              src="https://cdn.devdojo.com/images/december2020/drag-drop-hero.png"
              class="
                transform
                xl:translate-x-20
                lg:ml-0 lg:translate-y-20 lg:scale-125
              "
            />
          </div>
        </div>
