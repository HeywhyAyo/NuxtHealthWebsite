    ...
    <div class="grid grid-cols-1 lg:grid-cols-2">
      ...
      >
        <p
          ...
          "
        >
          Signup below to try our product today!
        </p>
        ...
        <form class="mt-5" onsubmit="event.preventDefault();">
          <label class="text-xs mb-0.5 font-medium leading-none text-gray-700"
            >Your Email</label
          >
          <input
            type=" email"
      ...
      >
        <div
          class="absolute inset-0 w-full h-full bg-cover opacity-100"
          style="
            background-image: url('https://uploads-ssl.webflow.com/5ec207a448d573153616868a/60e32beb6420a8d3ea4e0dd3_Mesh%2082.jpg');
          "
        ></div>
        ...
        <div class="relative flex mt-8 space-x-3">
          ...
          <div>
            ...
            <p class="mt-1 text-gray-500">
              Gain access to some premium tools and resources to help you take
        ...
        <div class="relative flex mt-8 space-x-3">
          ...
          <div>
            ...
            <p class="mt-1 text-gray-500">
              You'll also gain access to our amazing design templates and
              layouts for you to use in your project.
            </p>
          </div>
        </div>
        <div class="relative flex mt-8 space-x-3">
          ...
          <div>
            ...
            <p class="mt-1 text-gray-500">
              You will also have access to our developer tools that are designed
              to save and make you money.
            </p>
          </div>
        </div>
        <div class="relative flex mt-8 space-x-3">
          ...
          <div>
            ...
            <p class="mt-1 text-gray-500">
              Gain access to our premium help and support team that can help you
              on your journey.
            </p>
          </div>
        </div>
